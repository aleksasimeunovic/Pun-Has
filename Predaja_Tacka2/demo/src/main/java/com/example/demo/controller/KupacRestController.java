...
public class KupacRestController {
    ...
    public ResponseEntity<String> login(@RequestBody LoginDto loginDto, HttpSession session) {
        ...
        session.setAttribute("role", loggedKupac.getUloga());
        session.setAttribute("username",loggedKupac.getUsername());
        return new ResponseEntity(loggedKupac,HttpStatus.OK);
