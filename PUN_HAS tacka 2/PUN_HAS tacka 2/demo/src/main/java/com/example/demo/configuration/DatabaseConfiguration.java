...
public class DatabaseConfiguration {
    ...
    public boolean instantiate(){
        ...
        Admin korisnik02 = new Admin("Aleksa","123","Aleksa","Simeunovic", Korisnik.POLOVI.Musko,new java.util.Date(System.currentTimeMillis()), Korisnik.ULOGA.Admin);
        adminRepository.save(korisnik02);
        ...
        korisnikRepository.saveAll(List.of( korisnik3,korisnik4,korisnik5 ) );
        return true;
    }
}