...
public class KorisnikRestController {
    ...
    @Autowired
    private KorisnikRepository korisnikRepository; // sada je povezan sa rep.
    ...
    public String provera(HttpSession session){
        ...
        /*if(!session.getUloga(sesssion).equals(Korisnik.ULOGA.Admin)) KOSTUR ZA PROVERU */
    ...
    @GetMapping("/api/korisnik/pregled") // PREGLED KONKRETNOG KORISNIKA
    ...
    @PutMapping("/api/korisnik/izmeni") // IZMENA KORISNIKA
